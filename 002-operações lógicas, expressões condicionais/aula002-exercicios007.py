...
pergunta1 = input('Sente dor no corpo? ').upper()
pergunta2 = input('Você tem febre? ').upper()
pergunta3 = input('Você tem tosse? ').upper()
pergunta4 = input('Está com congestão nasal? ').upper()
pergunta5 = input('Tem manchas pelo corpo? ').upper()
